...
public class GetAccountBySsnTest extends WithApplication {
    ...
    @Test
    public void getAccountByExistingTaxNumberTest(){

        running(fakeApplication(inMemoryDatabase("test")), () -> {

            final AccountRepository accountRepository = app.injector().instanceOf(AccountRepository.class);
            final CompletionStage<Optional<Account>> stage = accountRepository.getBySsn(existsSsn);
    ...
    public void getAccountByNotExistingTaxNumber(){
        ...
        running(fakeApplication(inMemoryDatabase("test")), () -> {
            ...
            final AccountRepository accountRepository = app.injector().instanceOf(AccountRepository.class);
            final CompletionStage<Optional<Account>> stage = accountRepository.getBySsn(notExistsSsn);
