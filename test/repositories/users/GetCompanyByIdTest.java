...
public class GetCompanyByIdTest extends WithApplication {
    ...
    @Test
    public void getCompanyWithExistingId(){

        running(fakeApplication(inMemoryDatabase("test")), () -> {

            final CompanyRepository companyRepository = app.injector().instanceOf(CompanyRepository.class);
            final CompletionStage<Optional<Company>> stage = companyRepository.getById(existsId);
    ...
    @Test
    public void getCompanyWithNotExistingId(){

        running(fakeApplication(inMemoryDatabase("test")), () -> {

            final CompanyRepository companyRepository = app.injector().instanceOf(CompanyRepository.class);
            final CompletionStage<Optional<Company>> stage = companyRepository.getById(notExistsId);
