...
public class GetAccountByUserTest extends WithApplication {
    ...
    private Long notExistsUserId = 3L;
    ...
    @Test
    public void getAccountByExistingUserIdTest(){

        running(fakeApplication(inMemoryDatabase("test")), () -> {

            final AccountRepository accountRepository = app.injector().instanceOf(AccountRepository.class);
            final CompletionStage<Optional<Account>> stage = accountRepository.getByUser(existsUserId);
    ...
    @Test
    public void getAccountByNotExistsUserIdTest(){

        running(fakeApplication(inMemoryDatabase("test")), () -> {

            final AccountRepository accountRepository = app.injector().instanceOf(AccountRepository.class);
            final CompletionStage<Optional<Account>> stage = accountRepository.getByUser(notExistsUserId);
