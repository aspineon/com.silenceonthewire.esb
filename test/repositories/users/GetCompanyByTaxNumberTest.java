...
public class GetCompanyByTaxNumberTest extends WithApplication {
    ...
    @Test
    public void getCompanyWithExistingTaxNumberTest(){

        running(fakeApplication(inMemoryDatabase("test")), () -> {

            final CompanyRepository companyRepository = app.injector().instanceOf(CompanyRepository.class);
            final CompletionStage<Optional<Company>> stage = companyRepository.getByTaxNumber(existsTaxNumber);
    ...
    @Test
    public void getCompanyWithNotExistingTaxNumberTest(){

        running(fakeApplication(inMemoryDatabase("test")), () ->{

            final CompanyRepository companyRepository = app.injector().instanceOf(CompanyRepository.class);
            final CompletionStage<Optional<Company>> stage = companyRepository.getByTaxNumber(notExistsTaxNumber);
